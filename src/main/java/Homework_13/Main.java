...
class CommodityContainer {
    ...
    public void sortByName() {
        commodities.sort(new ComparatorByName());
        for (Commodity s : commodities) {
            System.out.println(s);
        }
        vizyal();
    ...
    public void sortByLenght() {
        commodities.sort(new ComparatorByLenght());
        for (Commodity s : commodities) {
            System.out.println(s);
        }
        vizyal();
    ...
    public void sortByWidth() {
        commodities.sort(new ComparatorByWidth());
        for (Commodity s : commodities) {
            System.out.println(s);
        }
        vizyal();
    ...
    public void sortByWeight() {
        commodities.sort(new ComparatorByWeight());
        for (Commodity s : commodities) {
            System.out.println(s);
        }
        vizyal();
...
class ComparatorByName implements Comparator<Commodity> {
    @Override
...
class ComparatorByLenght implements Comparator<Commodity> {
    @Override
    public int compare(Commodity o1, Commodity o2) {
...
class ComparatorByWidth implements Comparator<Commodity> {
    @Override
    public int compare(Commodity o1, Commodity o2) {
...
class ComparatorByWeight implements Comparator<Commodity> {
    @Override
    public int compare(Commodity o1, Commodity o2) {
